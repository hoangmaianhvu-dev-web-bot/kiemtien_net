  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
       ...
       <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-xl bg-white rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row">
            {/* Form Side */}
            <div className="flex-1 p-10 lg:p-12">
              <div className="mb-10">
                ...
                <p className="text-slate-500 font-medium">Tham gia cùng 50.000+ thành viên khác.</p>
              </div>

              {error && <div className="mb-6 p-4 bg-red-50 text-red-600 text-sm rounded-2xl font-bold flex items-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="pt-4">
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="w-full bg-slate-900 text-white py-5 rounded-2xl font-bold text-xl hover:bg-black transition-all shadow-xl active:scale-[0.98] disabled:opacity-50"
                  >
